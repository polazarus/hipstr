...
//! - `hipstr::UniqueHipStr` with the `Unique` backend.
//!
//! # Platform Support
//!
...
pub type UniqueHipByt<'borrow> = bytes::HipByt<'borrow, Unique>;

/// Unique string.
pub type UniqueHipStr<'borrow> = string::HipStr<'borrow, Unique>;

/// Unique byte sequence.
#[cfg(feature = "std")]
pub type UniqueHipOsStr<'borrow> = os_string::HipOsStr<'borrow, Unique>;

/// Unique path.
#[cfg(feature = "std")]
pub type UniqueHipPath<'borrow> = path::HipPath<'borrow, Unique>;
